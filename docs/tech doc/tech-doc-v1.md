...
Project Type: Frontend-only web platform Stage: Content planning & structuring Technology: HTML5, CSS3, JavaScript Backend: None Primary Goal: Provide an engaging digital space that encourages users to step away from passive scrolling and discover enjoyable offline activities.
...
Present useful activity-related content clearly.
Make discovering activities quick and enjoyable.
Encourage users to spend less time passively scrolling.
Provide a simple interactive form.
Demonstrate strong frontend development using HTML, CSS, and JavaScript.
Keep the initial architecture lightweight and easy to extend. 2. Site Structure & Content
...
Expand inside the same page, or
Open a dedicated activity detail page.
...
If valid, display a success state.
Pseudo-flow:
...
/_ Reduce or disable non-essential animations _/
}
4.6 UI States
...
Core principle: MODE:OFF should not feel like another addictive digital product. Its design and interactions should be calm, intentional, and focused on helping users discover what they can do away from the screen.
