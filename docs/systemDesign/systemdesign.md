MODE:OFF — UI/UX Design System & Visual Style Guide 0. Design Direction
...
Calm over stimulation — restrained colors, generous whitespace, minimal animation.
Human over corporate — friendly copy and imperfect, tactile visual details.
Offline over digital — visual cues should subtly reference paper, physical spaces, analog activities, and natural materials.
Discoverability without pressure — activities should invite exploration rather than feel like tasks.
Simple first, expressive second — the basic UI remains clean while selected elements can have personality.
...
Weight: 600 Line-height: 0.95–1.05
...
Weight: 600 Line-height: 1.0–1.1

H2
32–40px

Weight: 600 Line-height: 1.1–1.2

H3
22–28px

Weight: 600 Line-height: 1.2
...
Weight: 600 Letter spacing: 0.08–0.12em
...
background: #EEECE5 15. Interactive Form
...
Constant floating
Excessive parallax
Large rotations 19. Responsive Design
Desktop — 1200px+
Use:
...
Navigation
Short tagline
Copyright 21. Grid & Container System
...
Muted saturation
Warm temperature
No obvious stock-photo poses 24. Footer
